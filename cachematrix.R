## The activity aims to exercise the creation of functions that either
## cache or restore an inverse of a matrix

## makeCacheMatrix: is the function that orders a matrix object to store data’s inverse.
